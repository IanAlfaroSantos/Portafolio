...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-dark-bg pt-20">
      <div className="absolute top-1/4 -left-10 md:-left-20 w-64 h-64 md:w-96 md:h-96 bg-primary/20 blur-[100px] md:blur-[120px] rounded-full animate-pulse"></div>
      <div className="absolute bottom-1/4 -right-10 md:-right-20 w-72 h-72 md:w-[30rem] md:h-[30rem] bg-accent/10 blur-[120px] md:blur-[150px] rounded-full animate-float"></div>
      ...
      <div className="container mx-auto px-6 z-10 text-center flex flex-col items-center">
        ...
        <p className="text-primary font-bold tracking-[0.6em] uppercase mb-4 text-[10px] sm:text-xs animate-fade-in" data-aos="fade-right">
          Hola soy
        </p>

        <h1 className="text-5xl sm:text-7xl md:text-9xl font-black text-white tracking-tighter leading-none mb-6" data-aos="zoom-in">
        ...
        <div className="h-10 md:h-16 flex justify-center items-center mb-12" data-aos="fade-up" data-aos-delay="200">
          <h2 className="text-lg sm:text-2xl md:text-4xl font-medium text-white/40 tracking-tight typing-effect">
            {displayText}
          </h2>
        </div>
